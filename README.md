...
AI 垂直领域多平台热搜聚合。从社交平台（微博/知乎/B 站）按 AI 关键词过滤 + AI 原生平台（HuggingFace/GitHub Trending）采集热门内容，以卡片网格展示。
...
- **5 平台聚合**：微博、知乎、B 站（过滤） + HuggingFace、GitHub Trending（原生）
- **排名变化**：每轮对比上一轮快照，↑↓→● 实时可见
...
| 文档 | 内容 |
|------|------|
| [PRD-v2.md](PRD-v2.md) | 产品需求：AI 垂直定位，5 平台，视觉设计规范 |
